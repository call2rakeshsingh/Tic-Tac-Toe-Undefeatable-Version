...
function changeTurn(control) {
  ...
  if (count <= 9 && count != 12) {
    ...
    setTimeout(forComputerWinner, 300);
    setTimeout(gameDrawPopUp, 300);
    setTimeout(gameWinnerHighlight, 300);
  }
...
function computerTurn() {
  ...
  //Computer winner in Cross 2...
    ...
    let computerMoves = Math.ceil(Math.random() * 2);
  ...
  //If player 1 start from 1st cell
    ...
    let computerMoves = Math.ceil(Math.random() * 15);
    ...
    switch (computerMoves) {
      ...
      console.log(document.getElementById("boxText9").innerText);
      console.log(computerMoves);
      console.log(document.getElementById("boxText8").innerText);
      console.log(computerMoves);
  ...
  //If Player 1 starts 2nd cell
    ...
    let computerMoves = Math.ceil(Math.random() * 10);
